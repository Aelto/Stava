	...
	<div class="global background">
		...
		<div class="login-menu">
			...
			<div class="group">
				...
				<input type='text' v-model='global.summonerName'>
			</div>

			<div class="group">
				<div class="informations">Your Riot Games API key</div>
				<input type='password' v-model='global.apiKey'>
			</div>
			...
			<div class="group">
				...
				<input type="checkbox" name="name" value="" v-model='global.spectateAFriend'>
			</div>

			<button type="button" name="button" class='no-drag' v-on:click="manageSpectateInterval()"> {{ global.launchButtonText }} </button>
		...
		<comp-loading v-if='global.showLoading === true' :global='global'>
		</comp-loading>

		<comp-settings v-if='global.showSettingsFrame === true' :global="global">
		</comp-settings>

		<div class="controls drag-area">
			<div class="fa fa-minus no-drag" v-on:click='sendMinimizeCall()'></div>
			<div class="fa fa-gear no-drag" v-on:click='global.showSettingsFrame = !global.showSettingsFrame'></div>
			<div class="fa fa-times no-drag" v-on:click='sendCloseCall()'></div>
		</div>
